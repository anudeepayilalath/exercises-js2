...
let personNames = persons.map((answers)=>{return answers.name})// Complete here

let personsYoungerThan28YearsOld =persons.filter((young)=> {return young.age<28}) // Complete here
