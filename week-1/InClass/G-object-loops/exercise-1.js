...
const studentGrades = {
  ...
  for(piece in studentGrades){
    const a=studentGrades[piece]
   if(a>18){
     console.log(piece.toUpperCase()+" "+a)
   }
  };

  let newbie=Object.keys(studentGrades);

  let b=newbie.forEach((element)=>{
    if(element>18){ console.log(element+" ")}});
